...
export function Home() {
  ...
  return (
    <div className={style.container}>
      ...
      <CardPerson
        cover="https://static.vecteezy.com/ti/fotos-gratis/p3/3343387-desktop-source-code-and-wallpaper-by-coding-and-programming-gratis-foto.jpg"
          ...
          <form >
            ...
            <div className={style.headerContatos}>
              ...
              <div className={style.buttons}>
                <button className={style.buttomAdd} onClick={Adicionar}> <IoAdd /> </button>
                <button className={style.buttomEdit} onClick={Editar}> <IoPencil /> </button>
                <button className={style.buttomRemove} onClick={Deletar}> <BsFillTrash3Fill /> </button>
            ...
            <div className={style.pesquisa}>
              ...
              <input type='text' name='pesquisa' className={style.inputPesquisa} placeholder="Procure pelo nome de contato." value={valor} onChange={() => { setValor(event.target.value) }} />
            </div>
